        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="pull-right">
                    <a href="<?= site_url('stock/in/add')?>" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Add Stock</a>
                </div>
            </div>
                ...
                <table id="tabel" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <td class="text-center">
                            ...
                            <a href="<?= site_url('stock/in/del/'.$data->id_stock.'/'.$data->id_item)?>" onclick="return confirm('Apakah yakin akan menghapus data ini?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete</a></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
