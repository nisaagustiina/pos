        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="pull-right">
                    <a href="<?= site_url('stock/in')?>" class="btn btn-warning btn-xs"><i class="fa fa-undo"></i> Back</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-4 col-md-offset-1">
                        <form action="<?= site_url('stock/process')?>" method="post"">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="detail"  class="form-control" id="detail" placeholder="Kulakan/tambahan/etc">
                            </div>
                            <div class="form-group">
